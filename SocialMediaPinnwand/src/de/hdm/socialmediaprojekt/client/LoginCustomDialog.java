...
/**
 * 
 * Custom DialogBox um die Login Informationen des Google UserService zu
 * erweitern
 * 
 * @author Daniel Fink
 */
...
public class LoginCustomDialog extends DialogBox {
	...
	public LoginCustomDialog(String nickname) {
		...
		HTML msg = new HTML(
				"<center>Bitte tragen Sie untenstehende Informationen ein</center>",
				true);
		...
		dock.setSpacing(4);
		dock.add(erstelleNutzerButton, DockPanel.SOUTH);
